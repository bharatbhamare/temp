 ...
 */
public class DestinationConnectionFilter implements Filter {

    /**
     * Default constructor. 
     */
    public DestinationConnectionFilter() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(url.equals("")||port.equals("")||user.equals(""))
		{
			...
			request.getRequestDispatcher("destination-connection.jsp").forward(request, response);
		}else {
