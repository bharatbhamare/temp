								...
								<!--/login-->
									   ...
									   <div class="error_page">
												<!--/login-top-->
													...
													<div class="error-top">
													<h2 class="inner-tittle page">PG HUB</h2>
													    <div class="login">
														<h3 class="inner-tittle t-inner">Login</h3>
																...
																<form action="Login" method="post">
																		<input type="text" name="username" class="text" value="User Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'user name';}" >
																		...
																		<div class="new">
																			...
																			<!-- <p class="sign">Do not have an account ? <a href="sign.jsp">Sign Up</a></p> -->
																			<div class="clearfix"></div>
																		</div>
																	</form>
														</div>
										...
										<div class="footer">
										   ...
										   <p>&copy 2018 pg hub . All Rights Reserved | Design by <a href="" target="_blank">bharat.</a></p>
										</div>
									<!--footer section end-->
									<!--/404-->
<!--js -->
