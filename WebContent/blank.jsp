		...
		<!-- header-starts -->
			...
			<!--/sidebar-menu-->
				<div class="sidebar-menu">
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.jsp"> <span id="logo"> <h1>Augment</h1></span> 
			...
			<!--/down-->
							<div class="down">	
									  ...
									  <a href="index.jsp"><span class=" name-caret">Jasmin Leo</span></a>
								...
								<div class="menu">
										...
										<li><a href="index.jsp"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a></li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Tabs &amp; Panels</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
											...
											<li id="menu-academico-avaliacoes" ><a href="calender.jsp">Calender</a></li>
									...
									<li id="menu-academico" ><a href="#"><i class="lnr lnr-book"></i> <span>Pages</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										  <ul id="menu-academico-sub" >
											...
											<li id="menu-academico-boletim" ><a href="sign.jsp">Login2</a></li>
